...
if __name__ == "__main__":
    ...
    skip_columns = [args.label_col, 'adid', 'kadsidefeats_creativeidIndex', 'creativeid', 'xad_adinfo_tid',
                    'kadsidefeats_adinfo_gdtadinfo_advertiseridIndex',
    ...
    val_dataset = MultiShardsCSVDatasetV2([args.val_file], columns, all_feat_cols, args.label_col)
    val_loader = DataLoader(val_dataset, batch_size=args.batch_size, num_workers=1,
                            collate_fn=default_collate)

    test_dataset = MultiShardsCSVDatasetV2([args.test_file], columns, all_feat_cols, args.label_col)

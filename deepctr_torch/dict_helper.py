...
class Dict(object):
    ...
    def convertToIdx(self, labels, unkWord=UNK_WORD, bosWord=None, eosWord=None):
        vec = []
    ...
    def convertToIdxandOOVs(self, labels, unkWord=UNK_WORD, bosWord=None, eosWord=None):
        vec = []
        oovs = OrderedDict()
    ...
    def convertToIdxwithOOVs(self, labels, unkWord=UNK_WORD, bosWord=None, eosWord=None, oovs=None):
        vec = []
